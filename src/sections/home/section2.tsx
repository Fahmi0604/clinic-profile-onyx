            ...
            <div className="w-full h-full flex flex-col md:flex-row md:items-center md:justify-between ">
                ...
                <div className="relative w-full md:w-1/2 h-full overflow-hidden">
                    <div className="min-w-full md:min-h-screen w-full h-full flex animate-[slideShow_16s_linear_infinite]">
                        ...
                        {/* <Image src="/assets/images/home-section2-1.webp" alt="Image 1" fill className="" />
                        <Image src="/assets/images/home-section2-2.webp" alt="Image 2" width={500} height={500} className="object-cover" />
                        <Image src="/assets/images/home-section2-3.webp" alt="Image 3" width={500} height={500} className="object-cover" />
                        <Image src="/assets/images/home-section2-4.webp" alt="Image 4" width={500} height={500} className="object-cover" /> */}
                    </div>
                </div>
